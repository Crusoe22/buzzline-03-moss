...
def get_message_interval() -> int:
    ...
    interval = int(os.getenv("EVEREST_INTERVAL_SECONDS", 1))
...
DATA_FILE = DATA_FOLDER.joinpath("everest_temps.csv")
    ...
    while True:
        try:
            ...
            with open(DATA_FILE, "r") as csv_file:
                logger.info(f"Reading Everest weather data from file: {DATA_FILE}")
